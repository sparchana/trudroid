...
public class MessageConstants {
    ...
    public static final String REFER_SUB_MESSAGE = "Refer TruJobs app to your friends and help them with job search. Refer now via sms or whatzapp";
    ...
    public static final String TERMS_AND_CONDITIONS = "By visiting TruJobs mobile app you agree to be bound by the terms and conditions of this privacy policy. If you do not agree, please do not use or access our mobile app. By mere use of the mobile app, you expressly consent to, our use and disclosure, of your personal information in accordance with this Privacy Policy. This Privacy Policy is subject to the Terms of Services. If you have any questions or concerns regarding this Privacy Policy, you can contact our Support Team at info[at]trujobs.in\n" +
            ...
            "\nIn order to provide your complete profile information to the recruiting company, TruJobs might verify the authenticity of your documents information (such as Aadhaar, Driving License, PAN card, Passport etc) on a need basis \n\n" +
            "\nBy signing up you provide you agree to the below consent form\n\n" +
            "\nI hereby state that I have no objection in authenticating myself with Aadhaar based authentication system and consent to providing my Aadhaar number and Aadhaar information for Aadhaar based authentication for the purposes of availing of employment / training / management / payment and related services from Glasswing Infotech Pvt Ltd (www.trujobs.in)\n\n" +
            "\nI understand that the information I provide for authentication shall be used only for authenticating my identity through the Aadhaar Authentication system for that specific transaction and for no other purposes. I understand that Glasswing Infotech Pvt Ltd (www.trujobs.in) shall ensure security and confidentiality of my personal identity data provided for the purpose of Aadhaar based authentication.\n" +
            "\n" +
            "\nI hereby also authorize Glasswing Infotech (www.trujobs.in) to use my personal information, including my mobile number, Aadhaar number, name, gender, date of birth, native and current address, other Government issued ID number and information for the purpose of authentication, verifications, background checks, and creation of, or access to, my digital online profile that may enable view, verification, registration, update, ratings/reviews, testimonials, payments, activation/deactivation, incident reporting, document upload, and for other related services on the profile by Glasswing Infotech Pvt Ltd (www.trujobs.in) and/or on a platform managed by a third party.\n" +
            "\n" +
            "\nI also give my consent for all verifications and background checks, including but not limited to ID verification, address verification, police verification, criminal record checks, employment verification and education verification. I also agree that my profile on a third party platform will be available to other users of the platform if/when I provide my consent for the same.\\n";
}
